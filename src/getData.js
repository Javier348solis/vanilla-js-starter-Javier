...
import { updateTask } from "./updateData";
...
async function getDatos() {
    ...
    //    o si no las hay, esto tambien se logra con el '.style.display, que indica que si hay, se pone un "block", si no un "none"'
       ...
       // let paragraph = document.createElement("p") 
        ...
        paragraph.value=create1.nombre
        paragraph.id=create1.id
      //  paragraph.appendChild(btn)
        ...
        paragraph.addEventListener("click",function () {
            ...
            updateTask(paragraph.id,"COMER HAMBURGUESA")
        })
